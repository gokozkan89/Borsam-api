...
function hisseOneriGetir(req, res, next) {
    ...
    proc.exec("bitirme.spHisseOneriGetir", [], callback);
}
...
function hisseListesiGetir(req, res, next) {
    var proc = new sp();
    ...
    proc.exec("bitirme.spHisseListesiGetir", [], callback);
}
...
router.get('/hisseOneriGetir', hisseOneriGetir);
router.get('/hisseListesiGetir', hisseListesiGetir);

setInterval(emirKontrol2, 120000);
